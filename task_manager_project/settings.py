...
LOGIN_URL = "employees:employee-login"
...
AUTHENTICATION_BACKENDS = [
    "employees.backends.EmailBackend",  # authentication using EMAIL
]
...
print(STATIC_ROOT)
print(f"STATIC CONTENT --- {os.listdir(STATIC_ROOT)}")
